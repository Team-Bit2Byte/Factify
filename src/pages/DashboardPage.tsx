              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <XCircle className="text-error w-5 h-5 fill-current" />
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-outline-variant/10 group hover:border-primary/20 transition-all">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-outline-variant/10">
                ...
                <span className="text-xs font-bold px-2 py-0.5 bg-error-container text-error rounded">Hyper-Negative</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-outline-variant/10">
                <span className="text-sm text-secondary">Clickbait Score</span>
                <span className="text-xs font-bold px-2 py-0.5 bg-error-container text-error rounded">9.4 / 10</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-secondary">AI Authored</span>
                <span className="text-xs font-bold px-2 py-0.5 bg-surface-container-high text-on-surface-variant rounded">Likely (76%)</span>
              </div>
            </div>
          </div>
          {/* Image Analysis Card */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-outline-variant/10 group hover:border-primary/20 transition-all">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-outline-variant/10">
                ...
                <span className="text-xs font-bold px-2 py-0.5 bg-error-container text-error rounded">Detected</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-outline-variant/10">
                <span className="text-sm text-secondary">ELA Result</span>
                <span className="text-xs font-bold px-2 py-0.5 bg-surface-container-high text-on-surface-variant rounded">High Noise</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-secondary">Origin</span>
                <span className="text-xs font-bold px-2 py-0.5 bg-surface-container-high text-on-surface-variant rounded">Stock Asset</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-outline-variant/10 group hover:border-primary/20 transition-all">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-outline-variant/10">
                ...
                <span className="text-xs font-bold px-2 py-0.5 bg-error-container text-error rounded">Flagged</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-outline-variant/10">
                <span className="text-sm text-secondary">Domain Age</span>
                <span className="text-xs font-bold px-2 py-0.5 bg-surface-container-high text-on-surface-variant rounded">14 Days</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-secondary">IP Location</span>
                <span className="text-xs font-bold px-2 py-0.5 bg-surface-container-high text-on-surface-variant rounded">Obfuscated</span>
              </div>
            </div>
          </div>
        </div>
