  ...
  return (
    <aside className="hidden lg:flex flex-col h-screen w-64 fixed left-0 top-0 pt-20 bg-slate-100 p-4 gap-2">
      ...
      <div className="mt-auto pt-4 border-t border-slate-200">
        <button className="w-full flex items-center justify-center gap-2 bg-gradient-to-br from-primary to-primary-container text-white py-3 rounded-xl font-bold text-sm shadow-lg shadow-primary/20 hover:scale-[0.98] transition-transform">
          <Plus className="w-4 h-4" />
          New Analysis
        </button>
        <a className="flex items-center gap-3 px-4 py-2.5 mt-4 text-slate-600 hover:bg-slate-200 transition-all rounded-lg" href="#">
